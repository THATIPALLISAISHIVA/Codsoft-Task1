...
const ContactForm = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-r from-blue-400 to-purple-500 text-white font-sans flex flex-col-reverse mt-10  lg:flex-row gap-8 p-8 relative justify-end lg:items-stretch items-center">
